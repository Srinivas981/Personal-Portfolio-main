...
import innovat from "../../images/innnovate.png";
import learn from "../../images/learnsmasher.png";
import ui from "../../images/uipath.png";
                        ...
                        <Col md={4}>
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://drive.google.com/file/d/1UUfeNeVamwaGj_xmptwjUfnUdj19YWj5/view?usp=drive_link"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  RPA Developer Foundation(v2021.10)
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                                  style={{
                        ...
                        <Col md={4}>
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://credentials.uipath.com/59b96855-bd3f-40c6-86ab-a391171406eb#gs.g3co63"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
                        ...
                        <Col md={4}>
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://drive.google.com/file/d/1U9zsfs4oSejA0-8HlnjdAnj_41boiDlh/view?usp=drive_link"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
                        ...
                        <Col md={4} className="col-sm-12 col-md4">
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://drive.google.com/file/d/1UP4IgM-NPtodhj7wM-OayqsITpChk_4E/view?usp=drive_link"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>

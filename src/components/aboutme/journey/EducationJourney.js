      ...
      <VerticalTimeline>
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle mt-2">
            Little Angels High School,Bapatla
          </h4>
          <p>
            Studied here from Class 1 to 10th as a part of secondary school
            Certificate and gain CGPA 9.8 in my SSC Examination.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle mt-2">
            Sri Chaitanya Junior College, Bapatla
          </h4>
          <p>
            Studied Intermediate in stream of M.P.C from Sri Chaitanya Junior College
            and gain Percentage 94.6%.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
